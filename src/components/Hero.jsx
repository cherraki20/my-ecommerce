...
const slides = [
  {
    ...
    cta: "Découvrir",
    link: "/products?category=anti-intrusion",
  },
  {
    label: "SFIB SECURITY",
  ...
  },
  {
    ...
    cta: "Explorer",
    link: "/products?category=sonorisation",
  },
  {
    label: "SFIB SECURITY",
  ...
  },
  {
    ...
    cta: "En savoir plus",
    link: "/products?category=detection-incendie",
  },
];
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
                  <Link
                    ...
                    className="bg-[#1D6FF2] text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold hover:bg-[#1558d6] transition duration-300 text-sm sm:text-base text-center"
                  >
                    {slides[activeIndex].cta}
                  </Link>
                  <Link
                    to="/services"
                    className="border border-white/40 text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold hover:border-white transition duration-300 text-sm sm:text-base text-center"
                  >
                    En savoir plus
                  </Link>
                </div>
