...
export default function Navbar({ onOpenWishlist }) {
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <aside className="fixed right-0 top-[40px] bottom-0 w-[280px] bg-[#0B1F3A] shadow-2xl flex flex-col border-l border-[#1D6FF2]/30">
            ...
            <div className="p-4 border-t border-[#1D6FF2]/30">
              <button onClick={() => { setMobileOpen(false); onOpenWishlist(); }} className="w-full flex items-center justify-center gap-2 bg-[#1D6FF2] text-white py-3 rounded-full font-semibold hover:bg-[#1558d6] transition">
      ...
      <div className="bg-[#F8F9FA] border-b border-gray-200 py-2 px-8 shadow-sm relative z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a href="https://www.dsc.com/" target="_blank" rel="noreferrer">
              <img src="logo-dsc.png" className="h-7 hover:scale-110 transition" />
            </a>
      ...
      <div className="bg-[#0B1F3A] h-24 px-8 border-b border-[#1D6FF2]/30 flex items-center relative z-40">
        <div className="max-w-7xl mx-auto flex justify-between items-center w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* WISHLIST */}
            <button onClick={onOpenWishlist} className="relative p-2 text-white transition-transform hover:scale-110">
              <Heart className={`h-5 w-5 ${itemCount > 0 ? "fill-cyan-400 text-cyan-400" : ""}`} />
              {itemCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 flex h-4 w-4 items-center justify-center bg-red-500 text-[10px] font-bold rounded-full border border-[#0B1F3A]">
                  {itemCount}
                </span>
              )}
            </button>
